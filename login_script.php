...
/*		echo '<div class="container">';
        ...
        echo '<input class="form-control" id="login_input_username" type="text" name="user_name" required autofocus /> ';
        echo '<label for="login_input_password">Password</label> ';
        echo '<input class="form-control" id="login_input_password" type="password" name="user_password" required /> ';
        echo '<button type="submit"  class="btn btn-lg btn-success" name="login" value="Log in" >Log in</button>';
        echo '</form>';
		echo '</div> <!-- /container -->';
